...
The default permission settings in most of the applications permit data harvesting in the background without the full awareness of the users.
 The European Data Protection Board states that most of the mobile applications are not implemented correctly to meet the levels of transparency, as established by GDPR. It serves only to confirm that despite the powerful laws, privacy threat is still growing.
 
The moral dilemma in this case is with informed consent, autonomy, and imbalance of power. 
Frequently, the users may not understand what data is being recorded and how the data is stored, exchanged, or made a profit. 
...
Open algorithms, more open privacy policies, and limitations on redundant data storage are some of the main actions to be taken to guarantee the preservation of user autonomy.
...
Different schools, colleges and places of work can also develop digital literacy programs which will educate the people on the balanced and responsible use of their devices. 
...
The threat to privacy, addictive design, and environmental harm are not isolated issues that occur independently but are connected to each other due to a dynamic and fast-moving industry that is fueled by the need to satisfy consumer demands.
